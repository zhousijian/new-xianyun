    ...
    <div class="banner-content">
      <div class="search-bar">
        ...
        <el-row type="flex" class="search-tab">
          <span v-for="(item,index) in navs" :key="index" @click="handleclick(index)" :class="{active:index==navsindex}">
            <i>{{item.text}}</i>
          </span>
        </el-row>
        ...
        <el-row type="flex" align="middle" class="search-input">
          <input type="text" :placeholder="navs[navsindex].placeholder" />
